...
* **Language:** Java 17+
* **Key Concepts:** 
    * **OOP (Object Oriented Programming): Implementing multiple classes using Inheritance, Encapsulation, Abstraction and Polymorphism** 
    * **User Input Processing: Accepting user input using the Scanner Class and filtering it**  
    ...
    * **Immutable Record Class: Using this type of class to get the basic product's data**
